...
window.addEventListener("message", async (event) => {
  ...
  if (msgType === "IF_B_CAPTURE_SCREEN") {
    ...
    const framesToHide = Array.from(
      document.querySelectorAll("#spectralensWidgetIframe, #screenSelectorIframe, #spectralens-widget-intro, #spectralens-tour-overlay, iframe[id*='widgetWindow'], iframe[id*='menuWindow']"),
    );
