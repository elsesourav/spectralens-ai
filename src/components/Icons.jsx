...
export function GeminiIcon({ className = "w-4 h-4", size = 16, ...props }) {
  return (
    ...
    >
      ...
      <g mask="url(#gemini_maskme)">
        <g filter="url(#gemini_filter0_f)">
          <path
        ...
        <g filter="url(#gemini_filter3_f)">
          <path
            d="M20.184 82.608c10.753-.525 18.918-12.244 18.237-26.174-.68-13.93-9.95-24.797-20.703-24.271C6.965 32.689-1.2 44.407-.519 58.337c.681 13.93 9.95 24.797 20.703 24.271z"
            fill="#00B95C"
          />
        </g>
        <g filter="url(#gemini_filter4_f)">
          <path
        ...
        <g filter="url(#gemini_filter10_f)">
          <path
