...
export default function Sidebar({ activeTab, onSelectTab, onNewChat }) {
  ...
  const sidebarBgClass =
    contrastMode === "solid"
      ...
      : contrastMode === "medium"
      ? "bg-slate-100/30 dark:bg-black/20 backdrop-blur-sm border-r border-slate-200/40 dark:border-white/[0.06]"
      : "bg-transparent border-r border-slate-200/20 dark:border-white/[0.04]";
